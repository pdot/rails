...
Rails::Initializer.run do |config|
  ...
  config.gem 'thoughtbot-sortable_table', :lib => 'sortable_table', :source => 'http://gems.github.com'
...
ExceptionNotifier.exception_recipients = %w(corey.martella@gmail.com)
ExceptionNotifier.exception_recipients = %w(admin@pdot.ca)
